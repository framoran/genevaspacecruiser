...
var star_y = 0;
var temps_essence = 0;
var interactible_rock_halo = true;
...
var cometX = -1000;
var cometY = getRandomInt(25, 500);
...
function message() {
    ...
    this.draw = function() {
        ...
        context.fillStyle = "#FFFFFF";
        context.fillText(text_refueled, this.x, this.y);
                ...
                if ( (temps_essence > time_to_refuel_list[element] - interval_to_refuel) && (temps_essence < time_to_refuel_list[element]) ) {
                    ...
                    if (myGamePiece_Affichage.countPressPlein == 0) {
                        ...
                        if (cometActive && !cometShown){
                            if (interactible_rock_halo){
                                myGamePiece_DrawingComet.cometX = 1000;
                            }
                            myGamePiece_DrawingComet.cometY = getRandomInt(25, 500);
                            cometActive = false;
                            cometShown = true;
                        }
                    }
        ...
        if ((temps_essence > (time_to_refuel_list[element]-interval_to_refuel) && myGamePiece_DrawingComet.cometX > 0) && (game.keyCode3 == true) && (myGamePiece_Affichage.keypress == false)) {
            ...
            if (interactible_rock_halo){
                ...
                this.affichage_plein = 1500;
            }            
            
            this.countPressPlein = 1;
            
            // to make it not disappear when keypress
            /*setTimeout(function() {
                myGamePiece_DrawingComet.cometX = -1000;
            }, interval_to_refuel);*/
            // to make it disappear when keypress
            myGamePiece_DrawingComet.cometX = -1000;
...
function drawComet() {
    ...
    this.draw = function() {    
        ...
        context.drawImage(cometImage, this.cometX,  this.cometY , 150, 75);        
        
        if ((myGamePiece_Vaisseau.x > (this.cometX - 100)) && (myGamePiece_Vaisseau.x < (this.cometX + 100)) && (myGamePiece_Vaisseau.y > (this.cometY - 75)) && (myGamePiece_Vaisseau.y < (this.cometY + 75))) {
            var d = new Date();
            var e = d.getTime() - myGamePiece_Time.timeStart;
            impact.push(e);
            this.cometX = -500;
            this.cometY = (getRandomInt(25, 500));
            interactible_rock_halo = false;
            setTimeout(
                interactible_rock_halo = true,
                10000
            )
            if (myGamePiece_Affichage.score1 > 0 && myGamePiece_Affichage.score1 <= 100) {
                myGamePiece_Affichage.score1 = 0;
        ...
        if ((myGamePiece_Missile.nouveau_tir == true) && (myGamePiece_Missile.x > 0) && (myGamePiece_Missile.x < 1500) && (myGamePiece_Missile.x > (this.cometX - 1)) && (myGamePiece_Missile.x < (this.cometX + 30)) && (myGamePiece_Missile.y > (this.cometY - 50)) && (myGamePiece_Missile.y < (this.cometY + 50))) {
            if (myGamePiece_Affichage.score1 >= 0) {
                myGamePiece_Affichage.score1 += fire_rock_success;
            }
            impactMissile += 1;
            myGamePiece_Missile.x = this.cometX + 50;
            myGamePiece_Missile.Speed = 0;
            myGamePiece_Missile.sizeMx = 150;
            myGamePiece_Missile.sizeMy = 125;
            myGamePiece_Missile.y = this.cometY - 50;
            RocherExplosion(myGamePiece_GrosRocher, myGamePiece_Missile);
            this.cometX = -500;
            interactible_rock_halo = false;
            setTimeout(
