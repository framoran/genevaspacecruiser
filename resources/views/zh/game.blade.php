    ...
    <script>
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 65000) {
                        ...
                        context.fillText("非常棒！你已经完成了练习环节。", 300, 300);
                        game.redirect = true
                    }
                }
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                context.fillText("你已經加油了", this.affichage_plein, 100);
                context.fillStyle = "#FFFFFF";
                context.fillText('按鍵盤上的 "C" 鍵可顯示電量表。 ', this.AffichageTouche_C, 350);
                context.fillText('', this.AffichageTouche_C, 300);
                context.fillText("油位非常重要，請按空白鍵加油。", this.AffichageTouche_E, 350);
                context.fillText("", this.AffichageTouche_E, 300);
                ...
                if (new Date().getTime() > myGamePiece_Time.time + 1000) {
                    ...
                    if (temps_essence > 30 && temps_essence < 50) {
                        ...
                        if (myGamePiece_Affichage.countPress == 0) {
                            myGamePiece_Affichage.AffichageTouche_C = 300
                        } else {
                        ...
                        if (temps_essence > 50 && temps_essence < 60) {
                            ...
                            if (myGamePiece_Affichage.countPressPlein == 0) {
                                myGamePiece_Affichage.countPress = 1;
                                myGamePiece_Affichage.AffichageTouche_C = 2500;
                                myGamePiece_Affichage.AffichageTouche_E = 300
                            }
                        } else {
        ...
        function updateGame() {
            ...
            context.font = "30px Verdana";
            context.fillStyle = "#FFFFFF";
            context.fillText("分數 " + myGamePiece_Affichage.score1, 10, 50);
