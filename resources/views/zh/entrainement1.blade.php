    ...
    start : function() { // fonction start
		...
		function time(){
            ...
            context.fillRect(0,0,2000,2000);
    		    ...
    		    context.fillText("非常棒！现在你可以按 “F” 键练习发射导弹。", 250, 300);
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, 370, 250);
	context.fillText(myGamePiece_Affichage.text_ligne, 330, 310);
