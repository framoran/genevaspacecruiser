        ...
        @component('components.card')
            ...
            <div class="content elements-centered">
              ...
              <div class="elements-centered">
                ...
                <p class="instruction__example">The correct answer for this series is the number 1 because the circle symbol is accompanied by the number 1. You will have to click on « 1 » to respond, as shown below:</p>
                <div>
                ...
                <a href="intertask3" class="button is-primary mt-3"> Continue </a>
          	</div>
          </div>
    @endcomponent
  @endcomponent
