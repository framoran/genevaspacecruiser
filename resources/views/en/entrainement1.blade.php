    ...
    start : function() { // fonction start
		...
		function time(){
            ...
            context.fillRect(0,0,2000,2000);
    		    ...
    		    context.fillText("Very good! Now you can practice", 300, 300);
    		    context.fillText('firing missiles by pressing the "F" key.', 250, 350);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
  ...
  // OBJET message
  function message() {
    this.text1 = "Press the right arrow key on your keyboard";
    this.text2 = "Press the left arrow key on your keyboard";
    this.text3 = "Press the up arrow key on your keyboard";
    this.text4 = "Press the down arrow key on your keyboard ";
    this.text_ligne = "until the spaceship touches the edge of the screen.";
