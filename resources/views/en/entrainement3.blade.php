...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Press the "C" key on your keyboard to display ';
	this.tx = 190;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Press the "C" key on your keyboard again to display';
...
function updateGame() {
	...
	context.fillText("the fuel gauge.", 400, 300);
