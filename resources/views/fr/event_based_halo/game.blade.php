...
<body onload=startGame() style=background-color:black>
    ...
    <script>
        ...
        text_press_fuel_display_2 = "{!! __('game.text_press_fuel_display_5') !!}";
        text_press_fuel_touch_1 = "{!! __('game.text_press_fuel_display_3') !!}";
        text_press_fuel_touch_2 = "{!! __('game.text_press_fuel_display_5') !!}";

    </script>

    <script src="/js/practice_halo.js?v=2">
