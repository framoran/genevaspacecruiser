    ...
    @component('components.loggued')
        @component('components.card')
          ...
          <div class="content">
            ...
            <div class="elements-centered">
              Vous avez terminé le jeu!<br/><br/>
              Nous aimerions que vous estimiez votre future performance concernant la tâche de remplissage du réservoir d'essence si vous deviez refaire le jeu dans le future. <br> </br>
            ...
            <form id = "bouton_consigne buttonStyle" action="instruction7" method="get">
                  <p id = "p_consigne3">
              ...
              <script>
                  ...
                  slider2.oninput = function() {
                    ...
                    document.cookie = 'postdiction' + "=" + this.value + ";" + expires;                    
                  }
              </script>
            </div>
    @endcomponent
