    ...
    start : function() { // fonction start
		...
		function time(){
		    if (game.checkUpdate == false){
    		    ...
    		    context.fillText("Heel goed! Nu kunt u oefenen met het afvuren van raketten", 150, 300);
    		    context.fillText("bij het drukken op de “F” toets.", 150, 350);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
  ...
  // OBJET message
  function message() {
    this.text1 = "Druk op het pijltje naar rechts op het toetsenbord";
    this.text2 = "Druk op het pijltje naar links op het toetsenbord";
    this.text3 = "Druk op het pijltje naar boven op het toetsenbord";
    this.text4 = "Druk op het pijltje naar beneden op het toetsenbord";
    this.text_ligne = "tot het ruimteschip de grens van het scherm raakt.";
