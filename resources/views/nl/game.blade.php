    ...
    <script>
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 65000) {
                        ...
                        context.fillText("Goed gedaan. U heeft de oefensessie volbracht.", 200, 300);
                        game.redirect = true
                    }
                }
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                context.fillStyle = "#FFFFFF";
                context.fillText("Brandstof", this.x, this.y);
                ...
                context.fillText("Je hebt hem gevuld!", this.affichage_plein, 100);
                context.fillStyle = "#FFFFFF";
                context.fillText("Ergeet niet op de C-toets te drukken", this.AffichageTouche_C, 250);
                context.fillText("om het brandstofpeil te regelen!", this.AffichageTouche_C, 300);
                context.fillText("Het brandstofniveau is kritiek, druk op", this.AffichageTouche_E, 250);
                context.fillText("de spatiebalk om te tanken!", this.AffichageTouche_E, 300);
