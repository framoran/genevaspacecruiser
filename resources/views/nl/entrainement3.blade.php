...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Druk op de "C" toets van uw toetsenbord om';
	this.tx = 200;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		context.stroke();
		context.fillText("Je bent vol!", this.affichage_plein, 100);
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Druk op de "C" toets van uw toetsenbord om opnieuw';
...
function updateGame() {
	...
	context.fillText("de brandstofmeter te zien", 200, 300);
