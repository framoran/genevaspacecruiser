    ...
    <script>
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 65000) {
                        ...
                        context.fillText("Très bien. L’entraînement est terminé.", 200, 300);
                        game.redirect = true
                    }
                }
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                context.fillStyle = "#FFFFFF";
                context.fillText("N'oubliez pas d'appuyer sur la touche C", this.AffichageTouche_C, 250);
                context.fillText("afin de contrôler le niveau d'essence!", this.AffichageTouche_C, 300);
                context.fillText("Le niveau d'essence est critique, appuyez sur", this.AffichageTouche_E, 250);
                context.fillText("Barre Espace pour faire le plein!", this.AffichageTouche_E, 300);
