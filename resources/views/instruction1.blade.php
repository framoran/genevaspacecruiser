        ...
        @component('components.card')
            ...
            <div class="content elements-centered">
              ...
              <div>
                ...
                Chaque étoile récoltée vous fera gagner 30 points. <br><br>

                Pour vous déplacer avec le vaisseau, vous pouvez utiliser les flèches du clavier (haut, bas, gauche, droite). <br><br>

                Il vous faudra également éviter les rochers. Si votre vaisseau touche un des rochers, cela vous fera perdre 100 points. <br><br>
                ...
                Pour tirer un missile, appuyez sur la touche "F". Si vous détruisez un rocher, cela vous fera gagner 30 points. <br><br>
