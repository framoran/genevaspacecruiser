    ...
    <script>
        ...
        var game = {
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 370000) {
                        updateGame()
                    } else {
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                if ((temps_essence > 50 && temps_essence < 60) && (game.keyCode3 == true) && (myGamePiece_Affichage.keypress == false)) {
                    ...
                    if (this.checkScore) {
                        myGamePiece_Affichage.scoreEssence += 1;
                        myGamePiece_Affichage.checkScore = false;
                        setTimeout("checkScoreRestore()", 15000)
                    }
                    checkScoreRestore = function() {
                        myGamePiece_Affichage.checkScore = true
                    };
                    temps_essence = 0;
                    filled_variables = false;
                    this.longueur = 150;
