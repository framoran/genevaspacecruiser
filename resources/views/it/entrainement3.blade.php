...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Premi il tasto "C" sulla tastiera';
	this.tx = 250;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Premi di nuovo il tasto "C" sulla tastiera';
                   myGamePiece_Affichage.tx = 250;
               }
...
function updateGame() {
	...
	context.fillText("per visualizzare l'indicatore del carburante.", 250, 300);
