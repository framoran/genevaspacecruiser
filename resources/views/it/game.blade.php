    ...
    <script>
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 65000) {
                        ...
                        context.fillText("La pratica è finita", 350, 300);
                        game.redirect = true;
                    }
                }
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                context.fillStyle = "#FFFFFF";
                context.fillText("Carburante", this.x, this.y);
                ...
                context.fillText("Hai fatto rifornimento!", this.affichage_plein, 100);
                context.fillStyle = "#FFFFFF";
                context.fillText('Premi il tasto "C" sulla tastiera ', this.AffichageTouche_C, 250);
                context.fillText("per visualizzare l'indicatore del carburante.", this.AffichageTouche_C, 300);
                context.fillText("Il livello del carburante è critico premi ", this.AffichageTouche_E, 250);
                context.fillText("la barra spaziatrice per fare rifornimento.", this.AffichageTouche_E, 300);
