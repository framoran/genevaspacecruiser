    ...
    start : function() { // fonction start
		...
		function time(){
            ...
            context.fillRect(0,0,2000,2000);
    		    ...
    		    context.fillText("Molto bene! Ora puoi esercitarti a sparare i missili", 200, 300);
    		    context.fillText('premendo il tasto "F".', 200, 350);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
  ...
  function message() {
    ...
    this.text1 = "Premi il tasto freccia che punta a destra finché";
    this.text2 = "Premi il tasto freccia sinistra finché";
    this.text3 = "Premi il tasto freccia su finché";
    this.text4 = "Premi il tasto freccia giù finché";
    this.text_ligne1 = "l'astronave non tocca il bordo dello schermo.";
    this.text_ligne2 = "l'astronave non tocca il bordo dello schermo.";
    this.text_ligne3 = "l'astronave non tocca il bordo dello schermo.";
    this.text_ligne4 = "l'astronave non tocca il bordo dello schermo.";
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, 200, 250);
	context.fillText(myGamePiece_Affichage.text_ligne, 200, 310);
