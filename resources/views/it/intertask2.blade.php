        ...
        @component('components.card')
            ...
            <div class="content elements-centered">
              ...
              <div class="elements-centered">
                ...
                <p class="instruction__example">La risposta corretta per questa serie è il numero 1, perché il simbolo del cerchio è accompagnato dal numero 1. Dovrai cliccare su « 1 » per rispondere, come mostrato di seguito:</p>
                <div>
                ...
                <a href="intertask3" class="button is-primary mt-3"> Continua </a>
          	</div>
          </div>
    @endcomponent
  @endcomponent
