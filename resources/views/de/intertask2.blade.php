        ...
        @component('components.card')
            ...
            <div class="content elements-centered">
              ...
              <div class="elements-centered">
                ...
                <p class="instruction__example">Die richtige Antwort für diese Symbolreihe ist die Zahl 1, da das Kreissymbol von der Zahl 1 begleitet wird (darunter). Um zu antworten müssen Sie auf "1" klicken (wie unten gezeigt):</p>
                <div>
                ...
                <a href="intertask3" class="button is-primary mt-3"> Weiter </a>
          	</div>
          </div>
    @endcomponent
  @endcomponent
