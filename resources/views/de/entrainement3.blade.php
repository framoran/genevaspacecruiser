...
this.timeStart = timeStart;
  ...
  function message() {
	...
	this.longueur = 150;
	this.color = "#01DF01";
	this.text = 'Bitte drücken Sie die C-Taste ';
	this.tx = 300;
	this.score1 = 0;
	...
	this.draw = function() {
		...
		if ((game.keyCode2 == true) && (myGamePiece_Affichage.keypress == false)) {
		    ...
		    keyRestore = function(){
               ...
               if (game.update < 1){
                   game.update += 1;
                   myGamePiece_Affichage.text = 'Bitte drücken Sie erneut die C-Taste, ';
...
function updateGame() {
	...
	context.fillText("um die Tankanzeige anzuzeigen.", 300, 300);
