    ...
    start : function() { // fonction start
		...
		function time(){
            ...
            context.fillRect(0,0,2000,2000);
    		    ...
    		    context.fillText("Sehr gut! Jetzt können Sie das Abfeuern von Raketen üben,", 150, 300);
    		    context.fillText('indem Sie die "F"-Taste drücken.', 300, 350);
    		    game.redirect = true;
		    }
		}
...
this.timeStart = timeStart;
  ...
  // OBJET message
  function message() {
    this.text1 = "Drücken Sie die rechte Pfeiltaste (auf der Tastatur),";
    this.text2 = "Drücken Sie die linke Pfeiltaste (auf der Tastatur),";
    this.text3 = "Drücken Sie die Pfeiltaste nach oben (auf der Tastatur),";
    this.text4 = "Drücken Sie die Pfeiltaste nach unten (auf der Tastatur),";
    this.text_ligne1 = "bis das Raumschiff den rechten Rand des Bildschirms berührt.";
    this.text_ligne2 = "bis das Raumschiff den linken Rand des Bildschirms berührt.";
    this.text_ligne3 = "bis das Raumschiff den oberen Rand des Bildschirms berührt.";
    this.text_ligne4 = "bis das Raumschiff den unteren Rand des Bildschirms berührt.";
    ...
    this.text_ligne = this.text_ligne1;
	this.draw = function() {
	    ...
	    this.update = function(){
        	...
        	if (myGamePiece_Vaisseau.x < 1) {
        	    ...
        	    if (myGamePiece_Affichage.textCheck2 == true){
                  ...
                  myGamePiece_Affichage.text_ligne = myGamePiece_Affichage.text_ligne3;
        	...
        	if (myGamePiece_Vaisseau.x > 800) {
              ...
              myGamePiece_Affichage.text_ligne = myGamePiece_Affichage.text_ligne2;
        	...
        	if (myGamePiece_Vaisseau.y > 500) {
        	    ...
        	    if (myGamePiece_Affichage.textCheck4 == true){
                  ...
                  myGamePiece_Affichage.text_ligne = myGamePiece_Affichage.text_ligne1;
        	...
        	if (myGamePiece_Vaisseau.y < 25) {
        	    ...
        	    if (myGamePiece_Affichage.textCheck3 == true){
                  ...
                  myGamePiece_Affichage.text_ligne = myGamePiece_Affichage.text_ligne4;
...
function updateGame() {
	...
	context.font= "25px Verdana";
	context.fillStyle = "#FFFFFF";
	context.fillText(myGamePiece_Affichage.text, 150, 250);
	context.fillText(myGamePiece_Affichage.text_ligne, 100, 310);
