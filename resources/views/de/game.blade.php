    ...
    <script>
            ...
            start: function() {
                ...
                function d() {
                    if (new Date().getTime() < +x_time + 65000) {
                        ...
                        context.fillText("Das Training ist beendet.", 300, 300);
                        game.redirect = true;
                    }
                }
        ...
        function message() {
            ...
            this.draw = function() {
                ...
                context.fillStyle = "#FFFFFF";
                context.fillText("Tankanzeige", this.x, this.y);
                ...
                context.fillText("Sie haben aufgetankt!", this.affichage_plein, 100);
                context.fillStyle = "#FFFFFF";
                context.fillText('Bitte drücken Sie die C-Taste, ', this.AffichageTouche_C, 250);
                context.fillText('um die Tankanzeige anzuzeigen.', this.AffichageTouche_C, 300);
                context.fillText("Der Kraftstoffstand ist kritisch,", this.AffichageTouche_E, 250);
                context.fillText("drücken Sie die Leertaste, um zu tanken.", this.AffichageTouche_E, 300);
